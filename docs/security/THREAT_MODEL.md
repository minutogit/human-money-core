...
| **I**nformation Disclosure | Privacy Leak | Metadata (e.g., sender identity) leaks in Stealth Mode. | **Stealth Mode Rules**: Sender ID and Signature MUST be absent. Context binding ensures validity without revealing identity. |
...
| Attack Vector | Mechanism: Signature | Mechanism: Context Binding | Mechanism: Value Conservation | Mechanism: Stealth Rules |
| :--- | :---: | :---: | :---: | :---: |
| Replay Attack | | :white_check_mark: | | |
| Forged Amount | :white_check_mark: | | :white_check_mark: | |
| Identity Leak (Stealth) | | | | :white_check_mark: |
